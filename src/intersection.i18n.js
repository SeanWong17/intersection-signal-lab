...
const I18N = {
    zh: {
        ...
        "overlay.greenwaveOn": "主走廊偏移已启用: 南北相位差 {offset}s，观察车辆连续通过",
        ...
        "canvas.queueLabel": "排队 {queue}",
        "canvas.saturation": "启动流率≈{value} 辆/h/车道",
        "canvas.spaceTimeTitle": "{arm}进口时空图",
        "canvas.timeAxis": "时间 →",
        "canvas.distanceAxis": "距入口",
        "approach.vc": "v/c {value}"
    },
    en: {
        "page.title": "Intersection Signal Simulation",
        ...
        "demo.header": "Scenarios & Overlays",
        "demo.showQueue": "Queue-wave overlay",
        "demo.showSat": "Discharge-rate label",
        "demo.showSpaceTime": "Approach space-time view",
        ...
        "overlay.greenwaveOn": "Main-corridor offset enabled: north-south offset {offset}s, observe platoon progression",
        ...
        "canvas.queueLabel": "Queue {queue}",
        "canvas.saturation": "q≈{value} veh/h/lane",
        "canvas.spaceTimeTitle": "{arm} Approach Space-Time",
