...
const I18N = {
    zh: {
        ...
        "panel.intro": "四相位保护左转 · IDM 跟驰 · Webster 配时建议 · 过饱和与绿波演示",
        "button.run": "运行",
        "button.pause": "暂停",
        "button.reset": "重置",
        ...
        "stage.yellow": "黄灯",
        "stage.allred": "全红",
        "overlay.webster": "Webster 建议: C={cycle}s · 北{north}s 南{south}s 东{east}s 西{west}s",
    ...
    en: {
        ...
        "panel.intro": "Protected left turns · IDM car-following · Webster timing suggestion · Oversaturation and green-wave demos",
        "button.run": "Run",
        "button.pause": "Pause",
        "button.reset": "Reset",
        ...
        "overlay.webster": "Webster suggestion: C={cycle}s · N {north}s S {south}s E {east}s W {west}s",
