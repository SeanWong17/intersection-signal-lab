...
const I18N = {
    zh: {
        "page.title": "十字路口交通仿真系统",
        "panel.title": "十字路口信号控制仿真",
        "panel.intro": "四相位保护左转 · IDM 跟驰 · Webster 优化 · 过饱和与绿波演示",
        "button.run": "运行",
        "button.pause": "暂停",
        "button.reset": "重置",
        "button.webster": "Webster 优化",
        "button.oversat": "过饱和",
        ...
        "stage.yellow": "黄灯",
        "stage.allred": "全红",
        "overlay.webster": "Webster 最优: C={cycle}s · 北{north}s 南{south}s 东{east}s 西{west}s",
        "overlay.oversatLoaded": "过饱和场景已加载: v/c > 1，观察队列持续溢出",
        "overlay.greenwaveOn": "绿波协调启用: 主走廊相位差 {offset}s，观察车辆连续通过",
        ...
        "alert.saturation": "饱和流率实测: {value} 辆/h/车道",
    ...
    en: {
        "page.title": "Intersection Traffic Simulation",
        "panel.title": "Intersection Signal Control Simulation",
        "panel.intro": "Protected left turns · IDM car-following · Webster optimization · Oversaturation and green-wave demos",
        "button.run": "Run",
        "button.pause": "Pause",
        "button.reset": "Reset",
        "button.webster": "Webster",
        ...
        "metrics.saturation": "Measured Saturation",
        ...
        "direction.S": "S",
        "direction.W": "W",
        "phase.N": "Northbound Phase",
        "phase.E": "Eastbound Phase",
        "phase.S": "Southbound Phase",
        "phase.W": "Westbound Phase",
        "stage.green": "GREEN",
        "stage.yellow": "YELLOW",
        "stage.allred": "ALL-RED",
        "overlay.webster": "Webster optimum: C={cycle}s · N {north}s S {south}s E {east}s W {west}s",
        "overlay.oversatLoaded": "Oversaturated scenario loaded: v/c > 1, observe persistent queue spillback",
        "overlay.greenwaveOn": "Green wave enabled: main corridor offset {offset}s, observe platoon progression",
        ...
        "alert.saturation": "Measured saturation flow: {value} veh/h/lane",
        ...
        "canvas.queueLabel": "{arm}: {queue}",
        "canvas.saturation": "s≈{value} veh/h",
...
function renderStaticI18n() {
    ...
    const textMap = {
        ...
        phaseNorthLabel: "direction.N",
        phaseEastLabel: "direction.E",
        phaseSouthLabel: "direction.S",
        phaseWestLabel: "direction.W",
